...
Partial Class frmMaterial
    ...
    Private Sub InitializeComponent()
        ...
        Panelr2.Controls.Add(Panelr6)
        Panelr2.Controls.Add(PictureBox3)
        Panelr2.Controls.Add(Label6)
        Panelr2.Controls.Add(Panelr5)
        Panelr2.Controls.Add(PictureBox2)
        Panelr2.Controls.Add(Label5)
        Panelr2.Controls.Add(lbID)
        Panelr2.Controls.Add(Label4)
        Panelr2.Controls.Add(Label3)
        Panelr2.Controls.Add(Label2)
        Panelr2.Controls.Add(PictureBox1)
        ...
        ' txtTelefono
        ' 
        txtTelefono.BackColor = Color.FromArgb(CByte(250), CByte(250), CByte(250))
        txtTelefono.BorderStyle = BorderStyle.None
        txtTelefono.Font = New Font("Segoe UI", 14.25F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        txtTelefono.Location = New Point(3, 6)
        ...
        Panelr8.Location = New Point(554, 190)
        Panelr8.Name = "Panelr8"
        Panelr8.Size = New Size(206, 44)
        Panelr8.TabIndex = 17
        ' 
        ' Panelr9
        ' 
        ...
        ' 
        lbID.AutoSize = True
        lbID.Font = New Font("Arial", 18F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        lbID.ForeColor = Color.FromArgb(CByte(64), CByte(64), CByte(64))
        lbID.Location = New Point(696, 82)
        lbID.Name = "lbID"
        lbID.Size = New Size(64, 27)
        lbID.TabIndex = 6
        lbID.Text = "0001"
        ' 
        ' Label4
        ...
        Label4.Font = New Font("Arial", 18F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Label4.ForeColor = Color.FromArgb(CByte(64), CByte(64), CByte(64))
        Label4.Location = New Point(659, 82)
        Label4.Name = "Label4"
        ...
        Label3.Location = New Point(153, 92)
        Label3.Name = "Label3"
        Label3.Size = New Size(150, 17)
        Label3.TabIndex = 4
        Label3.Text = "Verifica la informacion"
        ' 
        ' Label2
        ' 
        ...
        Panelr3.Location = New Point(554, 450)
        ...
        Panelr1.Location = New Point(298, 450)
